...
await withStrapi(async (strapi) => {
  ...
  const DATA_ROUTE = {
    ...
    universityBoard: '/academics/student-success/university-counselling/',
    universityCards: '/academics/student-success/university-counselling/',
    universityDest: '/academics/student-success/university-counselling/',
    universityClose: '/academics/student-success/university-counselling/',
    boardOpen: '/academics/board-results/',
    boardPanel: '/academics/board-results/',
    boardDoes: '/academics/board-results/',
    boardFoot: '/academics/board-results/',
    boardClose: '/academics/board-results/',
    successOpen: '/academics/student-success/success-stories/',
    successMile: '/academics/student-success/success-stories/',
    successCta: '/academics/student-success/success-stories/',
    successClose: '/academics/student-success/success-stories/',
    scholarOpen: '/academics/student-success/scholarships/',
    scholarStories: '/academics/student-success/scholarships/',
    scholarEmpty: '/academics/student-success/scholarships/',
    scholarPaths: '/academics/student-success/scholarships/',
    scholarTerms: '/academics/student-success/scholarships/',
    scholarClose: '/academics/student-success/scholarships/',
    subjectRoutes: '/academics/student-success/subject-selection/',
    subjectDesk: '/academics/student-success/subject-selection/',
    subjectSteps: '/academics/student-success/subject-selection/',
    subjectVisual: '/academics/student-success/subject-selection/',
    subjectClose: '/academics/student-success/subject-selection/',
    olympiadSof: '/academics/student-success/olympiad-achievements/',
    olympiadNational: '/academics/student-success/olympiad-achievements/',
    olympiadAll: '/academics/student-success/olympiad-achievements/',
    olympiadClose: '/academics/student-success/olympiad-achievements/',
    classCornerDocs: '/academics/class-corner/',
    classCornerFoot: '/academics/class-corner/',
    toppersIntro: '/academics/class-corner/',
    toppersLabels: '/academics/class-corner/',
